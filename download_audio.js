// Simple script to download the Happy Birthday audio file
// This is a helper script since we need to place the audio file in the same directory as the HTML
